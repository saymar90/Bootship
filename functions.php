...
function bootship_scripts_styles() {
  ...
  wp_enqueue_script( 'tether', get_template_directory_uri() . '/js/tether.js', array(), '1.3.3', true );
  wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap.js', array( 'jquery', 'tether' ), '4.0.0-alpha.6', true );
  ...
  wp_enqueue_style( 'genericons', get_template_directory_uri() . '/fonts/genericons.css', array(), '3.4.1' );
	...
	wp_enqueue_style( 'tether', get_template_directory_uri() . '/css/tether.css', array(), '4.0.0-alpha.6' );
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.css', array(), '4.0.0-alpha.6' );
