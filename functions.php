...
function bootship_scripts_styles() {
  ...
  wp_enqueue_script( 'bootship-script', get_template_directory_uri() . '/assets/js/functions.js', array( 'jquery', 'wow', 'slick' ), '2020-08-09', true );
  wp_enqueue_script( 'popper', get_template_directory_uri() . '/assets/libs/popper/popper.js', array(), '2.11.8', true );
  wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/libs/bootstrap/js/bootstrap.js', array( 'jquery', 'popper' ), '5.3.5', true );

  // WOW.js @link https://github.com/matthieua/WOW
  wp_enqueue_script( 'wow', get_template_directory_uri() . '/assets/libs/wow/wow.js', array( 'jquery' ), '1.3.0', true );
  
  // Slick.js @link https://kenwheeler.github.io/slick/
  wp_enqueue_script( 'slick', get_template_directory_uri() . '/assets/libs/slick/slick.js', array( 'jquery' ), '1.8.1', true );
  ...
  wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/libs/bootstrap/css/bootstrap.css', array(), '5.3.5' );
  wp_enqueue_style( 'bootstrap-icons', get_template_directory_uri() . '/assets/libs/bootstrap-icons/bootstrap-icons.css', array(), '1.11.3' );
  wp_enqueue_style( 'bootship-theme', get_template_directory_uri() . '/assets/css/theme.css', array(), '2020-02-01' );
  wp_enqueue_style( 'bootship-default', get_template_directory_uri() . '/assets/css/default.css', array(), '2020-02-01' );
  wp_enqueue_style( 'bootship-style', get_stylesheet_uri(), array(), '2020-02-01' );

  // Animate CSS @link: https://animate.style stylesheet
  wp_enqueue_style( 'animate', get_template_directory_uri() . '/assets/libs/animate/animate.css', array(), '4.1.1' );

  // Hover CSS @link: https://github.com/IanLunn/Hover stylesheet
  wp_enqueue_style( 'hover', get_template_directory_uri() . '/assets/libs/hover/hover.css', array(), '2.3.2' );
  
  // Slick.css @link https://kenwheeler.github.io/slick/
  wp_enqueue_style( 'slick', get_template_directory_uri() . '/assets/libs/slick/slick.css', array(), 'v1.8.1' );
  wp_enqueue_style( 'slick-theme', get_template_directory_uri() . '/assets/libs/slick/slick-theme.css', array(), 'v1.8.1' );

  // Loads the Internet Explorer specific stylesheet.
  wp_enqueue_style( 'bootship-ie', get_template_directory_uri() . '/assets/css/ie.css', array( 'bootship-style' ), '2020-02-01' );
...
function bootship_customize_preview_js() {
	wp_enqueue_script( 'bootship-customizer', get_template_directory_uri() . '/assets/js/theme-customizer.js', array( 'customize-preview' ), '20130226', true );
}
