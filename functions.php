...
function bootship_scripts_styles() {
	...
	wp_enqueue_script( 'bootship-bootstrapjs', get_template_directory_uri() . '/js/bootstrap.js', array( 'jquery' ), '3.3.5', true );
  ...
  wp_enqueue_style( 'genericons', get_template_directory_uri() . '/fonts/genericons.css', array(), '2.09' );
	...
	wp_enqueue_style( 'fontawesome', get_template_directory_uri() . '/fonts/font-awesome.css', array(), '4.3.0' );

	// Loads our main stylesheet.
	wp_enqueue_style( 'bootship-bootstrapthemecss', get_template_directory_uri() . '/css/bootstrap-theme.css', array(), '3.3.5' );
	wp_enqueue_style( 'bootship-bootstrapcss', get_template_directory_uri() . '/css/bootstrap.css', array(), '3.3.5' );
